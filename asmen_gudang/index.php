...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        <li class="header"><h4 class="text-center">Umum 2</h4></li>
  ...
  <footer class="main-footer">    
	<marquee hspace="40" width="full-width">Umum 2 berhak menentukan barang apa saja yang boleh dikeluarkan</marquee>
